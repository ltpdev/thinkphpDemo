<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:77:"F:\phpDemo\thinkphpDemo\public/../application/index\view\article\article.html";i:1505830302;s:75:"F:\phpDemo\thinkphpDemo\public/../application/index\view\common\header.html";i:1505834022;s:74:"F:\phpDemo\thinkphpDemo\public/../application/index\view\common\right.html";i:1475987682;s:73:"F:\phpDemo\thinkphpDemo\public/../application/index\view\common\foot.html";i:1474777165;}*/ ?>
...
<div class="hotmenu">
    <div class="con">热门标签：
        ...
        <a href='http://localhost:4040/thinkphpDemo/public/index.php/index/search/index?keywords=<?php echo $vo['tagname']; ?>'><?php echo $vo['tagname']; ?></a>
        <?php endforeach; endif; else: echo "" ;endif; ?>
    </div>
</div>
        <!--顶部通栏-->
            ...
            <div class="left">
                ...
                <div class="xgread">
                    ...
                    <div class="rig">
                        <ul>
                            ...
                            <li><a href="<?php echo url('article/index',array('articleid'=>$vo[0])); ?>" target="_blank"><?php echo $vo['1']; ?></a></li>
                            <?php endforeach; endif; else: echo "" ;endif; ?>
                        </ul>
                    </div>
                </div>
                ...
                <div class="hotsnew">
                    ...
                    <ul>
                        ...
                        <li><div class="tu"><a href='<?php echo url('article/index',array('articleid'=>$vo['id'])); ?>' target="_blank">
                            <img  width="200" height="200" src="<?php if($vo['pic'] != ''): ?>__IMG__<?php echo $vo['pic']; else: ?>__PUBLIC__/images/error.png<?php endif; ?>" alt=""/></a></div><p><a href='<?php echo url('article/index',array('arid'=>$vo['id'])); ?>'><?php echo $vo['title']; ?></a></p></li>
                        <?php endforeach; endif; else: echo "" ;endif; ?>
                    </ul>
                </div>
            </div>
