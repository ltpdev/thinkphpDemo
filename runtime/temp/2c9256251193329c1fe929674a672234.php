<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:73:"F:\phpDemo\thinkphpDemo\public/../application/admin\view\article\add.html";i:1505746013;s:72:"F:\phpDemo\thinkphpDemo\public/../application/admin\view\common\top.html";i:1505745721;s:73:"F:\phpDemo\thinkphpDemo\public/../application/admin\view\common\left.html";i:1505647232;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
                ...
                <div id="horizontal-form">
                    <form class="form-horizontal" role="form" action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" id="author" placeholder="" name="author"  type="text" required="">
                            </div>
                            <p class="help-block col-sm-4 red">* 必填</p>
                        </div>
                        <div class="form-group">
