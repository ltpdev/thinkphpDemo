<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:72:"F:\phpDemo\thinkphpDemo\public/../application/admin\view\admin\edit.html";i:1505621268;s:73:"F:\phpDemo\thinkphpDemo\public/../application/admin\view\common\left.html";i:1505647232;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
                ...
                <div id="horizontal-form">
                    <form class="form-horizontal" role="form" action="" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" id="username" placeholder="" name="username" value="<?php echo $admins['username']; ?>" required="" type="text">
                            </div>
