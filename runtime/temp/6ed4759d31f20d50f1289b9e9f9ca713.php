<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:75:"F:\phpDemo\thinkphpDemo\public/../application/index\view\search\search.html";i:1505832476;s:75:"F:\phpDemo\thinkphpDemo\public/../application/index\view\common\header.html";i:1505834022;s:74:"F:\phpDemo\thinkphpDemo\public/../application/index\view\common\right.html";i:1475987682;s:73:"F:\phpDemo\thinkphpDemo\public/../application/index\view\common\foot.html";i:1474777165;}*/ ?>
...
<div class="overall">
	...
	<div class="left">
		...
		<img width="200"  height="200" src="<?php if($vo['pic'] != ''): ?>__IMG__<?php echo $vo['pic']; else: ?>__PUBLIC__/images/error.png<?php endif; ?>" alt=""/>
		</a></div>
		<div class="dec">
		...
		<?php
			...
			foreach ($arr as $k=>$v) {
				echo "<a href='http://localhost:4040/thinkphpDemo/public/index.php/index/search/index?keywords=$v'>$v</a>";
			}
		?>
		</div>
		</div>
