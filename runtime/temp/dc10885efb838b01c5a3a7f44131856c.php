<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:73:"F:\phpDemo\thinkphpDemo\public/../application/admin\view\login\login.html";i:1505744480;}*/ ?>
<!DOCTYPE html>
    ...
    <div class="login-container animated fadeInDown">
        <form action="" method="post">
            <div class="loginbox bg-white">
                ...
                <div class="loginbox-textbox">
                    <input class="form-control" placeholder="code" name="code" style="margin:10px 0;width:80px;float:left;" type="text" required>
